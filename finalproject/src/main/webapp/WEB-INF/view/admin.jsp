		...
		<form id="frm" method="post">
			...
			<table class="alt">
				<c:forEach var="dto" items="${list}" varStatus="status">
					<tr>
						<td><a href="#"
							onclick='location.href="adminPetKindUpdate.do?menu=${menu}&kind=${dto.kind}";'>${status.count}</a></td>
						<td>${dto.kind}</td>
						<td><input type="checkbox" id=${dto.kind } value=${dto.kind} ></input>
							<label for=${dto.kind}  }></label></td>
